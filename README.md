...
- **複核 (2026-08-19)**：例行 GCB 基準版本複核，未發現需要調整規則之異動；`GCB_CHECK/`、`GCB_SET/` 程式邏輯本次未變更。
  - 確認 NICS（國家資通安全研究院）現行公告仍為 `TWGCB-01-012 v1.2`（中華民國114年6月12日 / 1140612）與 `TWGCB-04-007 v1.2`，未發現正式發布之新版本，與 2026-07-17 之複核結論一致。
  - 留意到 NICS 已公開「115年政府組態基準GCB說明文件（預告版）」，惟屬預告版性質、尚未正式發布，本次暫不採用，待正式版公告後再行複核與更新。
